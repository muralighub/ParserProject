...
// This program enters the date in the format mmmm-dd-yyyy , mmmm-dd-yy, mmm-dd-yyyy using seperators -./,space. 
...
public class DateParserThree extends FormatUtility {
	WebDriver driver;
	// String resultformat;
	...
	public void dateParser(String date) {
		...
		String result = f.dateFormaterTwo(date);
	...
	public Object[][] getDateFormat1() {
		...
		// using separator "-" 
		getDate[0][0] = "July-02-2020";
		getDate[1][0] = "July-02-20";
		getDate[2][0] = "Jul-02-2020";
		getDate[3][0] = "Jul-02-20";
		
		// using separator "/"
		getDate[4][0] = "July/02/2020";
		getDate[5][0] = "July/02/20";
		getDate[6][0] = "Jul/02/2020";
		getDate[7][0] = "Jul/02/20";

		// using separator "space" 
		getDate[8][0] = "July 02 2020";
		getDate[9][0] = "July 02 20";
		getDate[10][0] = "Jul 02 2020";
		getDate[11][0] = "Jul 02 20";
